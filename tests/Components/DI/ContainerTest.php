...
class ContainerTest extends \Parable\Tests\Base
{
    ...
    {
        $diObject = $this->diProxy->create(\Parable\Tests\TestClasses\Basic::class);
        $this->assertSame("new", $diObject->value);
    }

    public function testGetInstanceReturnsSame()
    {
        $diObjectOriginal = $this->diProxy->get(\Parable\Tests\TestClasses\Basic::class);
        $this->assertSame("new", $diObjectOriginal->value);

        $diObjectOriginal->value = "updated";

        $diObject = $this->diProxy->get(\Parable\Tests\TestClasses\Basic::class);
    ...
    {
        $diObject = $this->diProxy->create(\Parable\Tests\TestClasses\DependsOnBasic::class);
    ...
    public function testStoreInstanceIsReturnedProperly()
    {
        ...
        $this->diProxy->store($diObjectOriginal);
    ...
    public function testExceptionOnInvalidClass()
    {
        ...
        $this->diProxy->create("This test no existy");
    }
    ...
    public function testExceptionOnCyclicalDependency()
    {
        ...
        $this->diProxy->create(\Parable\Tests\TestClasses\CyclicA::class);
    }
}
